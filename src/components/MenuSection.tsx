                    ...
                    <div className="pt-3 border-t border-white/10 flex flex-col gap-2.5">
                      <div className="flex items-center justify-between gap-2">
                        ...
                        {!product.availability ? (
                          ...
                          <button
                            ...
                            className="bg-gradient-to-r from-amber-400 to-yellow-500 hover:from-amber-500 hover:to-yellow-600 text-black font-black px-4 py-2 rounded-xl text-xs flex items-center gap-1 transition shadow-glow-gold active:scale-95 touch-manipulation shrink-0"
                          >
                            <Plus className="w-4 h-4 text-black stroke-[3]" /> ADD TO CART
                          </button>
                        ) : (
                          <div className="flex items-center bg-secondary border-2 border-amber-400 rounded-xl px-2 py-1 shadow-glow-sm shrink-0">
                            <button
                              onClick={() => updateQuantity(product.id, qty - 1)}
                              className="w-6 h-6 rounded-lg bg-white/10 hover:bg-amber-500 hover:text-black text-white flex items-center justify-center transition text-xs font-bold active:scale-95"
                            >
                              <Minus className="w-3.5 h-3.5" />
                            </button>
                            <span className="px-2.5 text-xs font-black text-amber-400">{qty}</span>
                            <button
                              onClick={() => updateQuantity(product.id, qty + 1)}
                              className="w-6 h-6 rounded-lg bg-amber-400 hover:bg-amber-500 text-black flex items-center justify-center transition text-xs font-bold active:scale-95"
                            >
                      ...
                      {product.availability && (
                        <button
                          ...
                          className="w-full bg-white/10 hover:bg-amber-400 text-white hover:text-black border border-white/20 hover:border-amber-400 font-extrabold py-2.5 rounded-xl text-xs flex items-center justify-center gap-1.5 transition active:scale-95 touch-manipulation"
                        >
                          <Zap className="w-3.5 h-3.5 text-amber-400 fill-amber-400 group-hover:text-black group-hover:fill-black" />
